...
report_sxw.report_sxw('report.registro_beni_ammortizzabili_report_webkit',
                       'registro_beni_ammortizzabili',
                       'addons/openforce_asset_fiscal/templates/registro_beni_ammortizzabili_webkit.mako',
                       parser=Parser)
