...
class asset_invoice_line(osv.osv_memory):
    """
    Invoice link asset
    """
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(asset_invoice_line, self).default_get(cr, uid, fields, context=context)
        
        #invoice_lines = self.pool.get('account.invoice.line').search(cr, uid, [('invoice_id','=',context['invoice_id'])])
