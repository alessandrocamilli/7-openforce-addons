...
class report_italian_balance(report_sxw.rml_parse):
...
report_sxw.report_sxw('report.l10n_it_account_report_balance',
                       'account.account', 
                       'addons/l10n_it_account_report_balance/report/report_italian_balance.mako',
                       parser=report_italian_balance)
