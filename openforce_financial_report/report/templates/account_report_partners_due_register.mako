            ...
            <div class="act_as_row labels">
                ...
                <div class="act_as_cell">
                    %if filter_form(data) == 'filter_date':
                        ${_('Dates Filter')}
                    %else:
                        %if filter_form(data) == 'filter_date_maturity':
                            ${_('Maturity Dates Filter')}
                        %else:
                            ${_('Periods Filter')}
                        %endif
                    %endif
                ...
                <div class="act_as_table list_table" style="margin-top: 5px;">
                    ...
                    <div class="act_as_thead">
                        <div class="act_as_row labels">
                            ...
                            ## amount tot invoice
                            <div class="act_as_cell amount" style="width: 70px;">${_('Amount Tot')}</div>
                            ## partner
                            <div class="act_as_cell" style="width: 160px;">${_('Partner')}</div>
                            ## label
                            <div class="act_as_cell" style="width: 140px;">${_('Label')}</div>
                            ## Payment type
                            <div class="act_as_cell" style="width: 70px;">${_('Type')}</div>
                            ## date maturity
                            <div class="act_as_cell" style="width: 70px;">${_('Due Date')}</div>
                            ## reconcile
                    ...
                    <div class="act_as_tbody">
                        ...
                        %for line in account.ledger_lines.get(p_id, []):
                          ...
                          %>
                            <div class="act_as_row lines">
                              ...
                              ## move
                              %if line.get('move_name') == '/' and line.get('unsolved_invoice_number') :
                                    <div class="act_as_cell">${line.get('unsolved_invoice_number') or ''} - ${formatLang(line.get('unsolved_invoice_date') or '', date=True)}</div>
                              %else:
                                    <div class="act_as_cell">${line.get('move_name') or ''}</div>
                              %endif
                              ## amount tot invoice
                              <div class="act_as_cell amount">${formatLang(line.get('invoice_amount_total') or 0.0) | amount }</div>
                              ## partner 
                              <div class="act_as_cell overflow_ellipsis">${line.get('partner_name') or ''}</div>
                              ## label
                              <div class="act_as_cell">${label}</div>
                              ## Payment type
                              <div class="act_as_cell">${line.get('payment_type') or ''}</div>
                              ## date maturity
                        ...
                        <div class="act_as_row lines labels">
                          ...
                          <div class="act_as_cell"></div>
                          ## label
                          <div class="act_as_cell">${_('Cumulated Balance')}</div>
                          ## Payment type
                          <div class="act_as_cell"></div>
                          ## date maturity
                          <div class="act_as_cell"></div>
